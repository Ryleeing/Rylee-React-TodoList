/* md5: 2e24ce8ed11fb231f53684c9ef7bf29b */
/* Rap仓库id: 275791 */
...
export const RequestTypes = {
  'GET/example/1610960276299': [
    'GET/example/1610960276299_REQUEST',
    'GET/example/1610960276299_SUCCESS',
    'GET/example/1610960276299_FAILURE',
  ],
...
interface IRapperStore {
  'GET/example/1610960276299': Array<
    reduxLib.IInterfaceInfo & {
      request: IModels['GET/example/1610960276299']['Req']
      response: IResponseTypes['GET/example/1610960276299']
    }
  >
...
export const useResponse = {
   ...
   */
  'GET/example/1610960276299': function useData(
    filter?:
      | {request?: IModels['GET/example/1610960276299']['Req']}
      | {(storeData: IRapperStore['GET/example/1610960276299'][0]): boolean}
  ) {
    type Req = IModels['GET/example/1610960276299']['Req']
    type Item = IRapperStore['GET/example/1610960276299'][0]
    type Res = IResponseTypes['GET/example/1610960276299']
    return reduxLib.useResponseData<TRapperStoreKey, Req, Res | undefined, Item>('GET/example/1610960276299', filter)
  },
...
export const useAPI = {
   ...
   */
  'GET/example/1610960276299': function useData(
    requestParams?: IModels['GET/example/1610960276299']['Req'],
    extra?: reduxLib.IUseAPIExtra<IModels['GET/example/1610960276299']['Req']>
  ) {
    type Req = IModels['GET/example/1610960276299']['Req']
    type Res = IResponseTypes['GET/example/1610960276299']
    type IFetcher = typeof fetch['GET/example/1610960276299']
    return reduxLib.useAPICommon<TRapperStoreKey, Req, Res | undefined, IFetcher>({
      modelName: 'GET/example/1610960276299',
      fetcher: fetch['GET/example/1610960276299'],
      requestParams,
      extra,
    })
  },
...
export const useAllResponse = {
  ...
  'GET/example/1610960276299': function useData() {
    return useSelector((state: reduxLib.IState) => {
      const selectedState =
        (state['$$rapperResponseData'] && state['$$rapperResponseData']['GET/example/1610960276299']) || []
...
export const clearResponseCache = {
   ...
   * Rap 地址: http://rap2.taobao.org/repository/editor?id=275791&mod=436102&itf=1857115
   */
  'GET/example/1610960276299': (): void => {
    reduxLib.dispatchAction({
      type: '$$RAPPER_CLEAR_STORE',
      payload: {'GET/example/1610960276299': undefined},
    })
  },
...
export const rapperDataSelector = {
  'GET/example/1610960276299': (state: reduxLib.IState) => {
    type Res = IResponseTypes['GET/example/1610960276299']
    return reduxLib.getRapperDataSelector<TRapperStoreKey, Res>(state, 'GET/example/1610960276299')
  },
